...
<%
	MemberVO vo1 = new MemberVO("홍길동","길동@nate.com", 40); 
	MemberVO vo2 = new MemberVO("저길동","저동@nate.com", 50); 
	MemberVO vo3 = new MemberVO("구길동","구동@nate.com", 60); 
	MemberVO vo4 = new MemberVO("말길동","말동@nate.com", 70); 
